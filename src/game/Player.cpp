...
void Player::_SaveStats()
{
    ...
    ss << GetFloatValue(PLAYER_BLOCK_PERCENTAGE) << ", "
      ...
      << (GetUInt32Value(MANGOSR2_AP_MELEE_1)+GetUInt32Value(MANGOSR2_AP_MELEE_2)) << ", "
      << (GetUInt32Value(MANGOSR2_AP_RANGED_1)+GetUInt32Value(MANGOSR2_AP_RANGED_2)) << ", "
      << GetUInt32Value(MANGOSR2_BLOCKRATING) << ", "
      << GetUInt32Value(MANGOSR2_DEFRATING) << ", "
      << GetUInt32Value(MANGOSR2_DODGERATING) << ", "
      << GetUInt32Value(MANGOSR2_PARRYRATING) << ", "
      << GetUInt32Value(MANGOSR2_RESILIENCE) << ", "
      << GetFloatValue(MANGOSR2_MANAREGEN) << ", "
      << GetUInt32Value(MANGOSR2_MELEE_HITRATING) << ", "
      << GetUInt32Value(MANGOSR2_MELEE_CRITRATING) << ", "
      << GetUInt32Value(MANGOSR2_MELEE_HASTERATING) << ", "
      << GetFloatValue(MANGOSR2_MELEE_MAINMINDMG) << ", "
      << GetFloatValue(MANGOSR2_MELEE_MAINMAXDMG) << ", "
      << GetFloatValue(MANGOSR2_MELEE_OFFMINDMG) << ", "
      << GetFloatValue(MANGOSR2_MELEE_OFFMAXDMG) << ", "
      << GetFloatValue(MANGOSR2_MELLE_MAINTIME) << ", "
      << GetFloatValue(MANGOSR2_MELLE_OFFTIME) << ", "
      << GetUInt32Value(MANGOSR2_RANGED_CRITRATING) << ", "
      << GetUInt32Value(MANGOSR2_RANGED_HASTERATING) << ", "
      << GetUInt32Value(MANGOSR2_RANGED_HITRATING) << ", "
      << GetFloatValue(MANGOSR2_RANGED_MINDMG) << ", "
      << GetFloatValue(MANGOSR2_RANGED_MAXDMG) << ", "
      << GetFloatValue(MANGOSR2_RANGED_ATTACKTIME) << ", "
      << GetUInt32Value(MANGOSR2_SPELL_HITRATING) << ", "
      << GetUInt32Value(MANGOSR2_SPELL_CRITRATING) << ", "
      << GetUInt32Value(MANGOSR2_SPELL_HASTERATING) << ", "
      << GetUInt32Value(MANGOSR2_SPELL_BONUSDMG) << ", "
      << GetUInt32Value(MANGOSR2_SPELL_BONUSHEAL) << ", "
      << GetFloatValue(MANGOSR2_SPELL_CRITPROC) << ", "
