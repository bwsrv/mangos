-- Hunter pets
UPDATE pet_scaling_data SET sta = 65, apbasescale = 210 WHERE creature_entry = 1 AND aura = 0;
UPDATE pet_scaling_data SET sta = 12 WHERE creature_entry = 1 AND aura = 62758;
UPDATE pet_scaling_data SET sta = 25 WHERE creature_entry = 1 AND aura = 62762;
