...
(607, 3, 1, 'Relic Spirit Healers A'),
(607, 3, 2, 'Relic Spirit Healers H'),
(607, 4, 3, 'Bombs at Yellow gate A'),
(607, 4, 4, 'Bombs at Yellow gate H'),
(607, 5, 1, 'Beach - A attacking'),
(607, 5, 2, 'Beach - H attacking'),
(607, 6, 0, 'Bomb A'),
(607, 6, 1, 'Bomb H'),
...
DELETE FROM creature WHERE guid BETWEEN 200017 AND 200032;
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
(200025, 13117, 607, 3, 1, 0, 0, 1389.22, 205.673, 32.0597, 4.445, 25, 0, 0, 37420, 6310, 0, 0),
(200026, 13116, 607, 3, 1, 0, 0, 1389.22, 205.673, 32.0597, 4.445, 25, 0, 0, 37890, 6310, 0, 0),
(200027, 13117, 607, 3, 1, 0, 0, 1400.49, -293.963, 32.0608, 2.08096, 25, 0, 0, 37420, 6310, 0, 0),
(200028, 13116, 607, 3, 1, 0, 0, 1400.49, -293.963, 32.0608, 2.08096, 25, 0, 0, 37890, 6310, 0, 0),
(200029, 13117, 607, 3, 1, 0, 0, 1111.58, 6.40605, 69.2963, 6.20037, 25, 0, 0, 37420, 6310, 0, 0),
(200030, 13116, 607, 3, 1, 0, 0, 1111.58, 6.40605, 69.2963, 6.20037, 25, 0, 0, 37890, 6310, 0, 0),
(200031, 13117, 607, 3, 1, 0, 0, 952.963, -192.742, 92.3584, 0.35779, 25, 0, 0, 37420, 6310, 0, 0),
(200032, 13116, 607, 3, 1, 0, 0, 952.963, -192.742, 92.3584, 0.35779, 25, 0, 0, 37890, 6310, 0, 0);

DELETE FROM creature_battleground WHERE guid BETWEEN 200017 AND 200032;
INSERT INTO creature_battleground VALUES
(200017, 5, 2),
(200018, 5, 1),
(200019, 1, 2),
...
(20000, 'The battle for Strand of the Ancients begins in 2 minute.', NULL, NULL, 'Die Schlacht um den Strand der Uralten beginnt in 2 Minuten.', NULL, NULL, 'La batalla por la Playa de los Ancestros comenzará en 2 minutos.', 'La batalla por la Playa de los Ancestros comenzará en 2 minutos.', '????? ?? ????? ??????? ???????? ????? 2 ??????.'),
(20001, 'The battle for Strand of the Ancients begins in 1 minute.', NULL, NULL, 'Die Schlacht um den Strand der Uralten beginnt in 1 Minute.', NULL, NULL, 'La batalla por la Playa de los Ancestros comenzará en 1 minuto.', 'La batalla por la Playa de los Ancestros comenzará en 1 minuto.', '????? ?? ????? ??????? ???????? ????? 1 ??????.'),
(20002, 'The battle for Strand of the Ancients begins in 30 seconds.', NULL, NULL, 'Die Schlacht um den Strand der Uralten beginnt in 30 Sekunden.', NULL, NULL, 'La batalla por la Playa de los Ancestros comenzará en 30 segundos. !Preparaos!', 'La batalla por la Playa de los Ancestros comenzará en 30 segundos. !Preparaos!', '????? ?? ????? ??????? ???????? ????? 30 ??????. ????????????!'),
(20003, 'The battle for Strand of the Ancients has begun!', NULL, NULL, 'Lasst die Schlacht um den Strand der Uralten beginnen!', NULL, NULL, '!Que comience la batalla por la Playa de los Ancestros!', '!Que comience la batalla por la Playa de los Ancestros!', '????? ?? ????? ??????? ????????! '),
(20004, 'The %s is under attack!', NULL, NULL, '%s wird angegriffen!', NULL, NULL, '!La puerta %s esta siendo asediada!', '!La puerta %s esta siendo asediada!', '????? %s ???????????? ?????????!'),
(20005, 'The %s is damaged!', NULL, NULL, '%s ist beschadigt!', NULL, NULL, '!La puerta %s ha sido danada!', '!La puerta %s ha sido danada!', '????? %s ??????????!'),
(20006, 'The %s was destroyed!', NULL, NULL, '%s ist zerstort!', NULL, NULL, '!La puerta %s ha sido destruida!', '!La puerta %s ha sido destruida!', '????? %s ??????????!'),
(20007, 'Gate of the Green Emerald', NULL, NULL, 'Das Tor des Smaragdhorizonts', NULL, NULL, 'de la Esmeralda Verde', 'de la Esmeralda Verde', '???????? ????????'),
(20008, 'Gate of the Blue Sapphire', NULL, NULL, 'Das Tor des Saphirhimmels', NULL, NULL, 'del Zafiro Azul', 'del Zafiro Azul', '?????? ???????'),
(20009, 'Gate of the Purple Amethyst', NULL, NULL, 'Das Tor des Amethysystems', NULL, NULL, 'de la Amatista Púrpura', 'de la Amatista Púrpura', '???????? ????????'),
(20010, 'Gate of the Red Sun', NULL, NULL, 'Das Tor der Rubinsonne', NULL, NULL, 'del Sol Rojo', 'del Sol Rojo', '???????? ??????'),
(20011, 'Gate of the Yellow Moon', NULL, NULL, 'Das Tor des Goldmondes', NULL, NULL, 'de la Luna Amarilla', 'de la Luna Amarilla', '?????? ????'),
(20012, 'Chamber of Ancient Relics', NULL, NULL,'Die Kammer der Uralten', NULL, NULL, 'Cámara de Reliquias Antiguas', 'Cámara de Reliquias Antiguas', '??????? ??????? ???????'),
(20013, 'East graveyard!', NULL, NULL, 'ostlicher Friedhof!', NULL, NULL, 'Cementerio Este', 'Cementerio Este', '????????? ????????!'),
(20014, 'West graveyard!', NULL, NULL, 'westlicher Friedhof!', NULL, NULL, 'Cementerio Oeste', 'Cementerio Oeste', '???????? ????????!'),
(20015, 'South graveyard!', NULL, NULL, 'sudlicher Friedhof!', NULL, NULL, 'Cementerio Sur', 'Cementerio Sur', '????? ????????!'),
(20016, '$n placed a Seaforium Charge!', NULL, NULL, '$n plaziert eine Zephyriumladung!', NULL, NULL, '!$n ha colocado una carga de seforio!', '!$n ha colocado una carga de seforio!', '$n ??????? ?????????? ?????!'),
(20017, 'The Alliance won the first round, the Relic of Titan was captured!', NULL, NULL, 'Die Allianz hat die erste Runde gewonnen, das Titanenportal erobert!', NULL, NULL, '!La Alianza gana la primera ronda! !La reliquia de Titán ha sido capturada!', '!La Alianza gana la primera ronda! !La reliquia de Titán ha sido capturada!', '?????? ????? ?? ????????! ???????? ?????? ?????????!'),
(20018, 'The Horde won the first round, the Relic of Titan was captured!', NULL, NULL, 'Die Horde hat die erste Runde gewonnen, das Titanenportal erobert!', NULL, NULL, '!La Horda gana la primera ronda! !La reliquia de Titán ha sido capturada!', '!La Horda gana la primera ronda! !La reliquia de Titán ha sido capturada!', '?????? ????? ?? ?????! ???????? ?????? ?????????!'),
(20019, 'The Alliance won the second round, the Relic of Titan was captured!', NULL, NULL, 'Die Allianz hat die zweite Runde gewonnen, das Titanenportal erobert!', NULL, NULL, '!La Horda gana la segunda ronda! !La reliquia de Titán ha sido capturada!', '!La Horda gana la segunda ronda! !La reliquia de Titán ha sido capturada!', '?????? ????? ?? ????????! ???????? ?????? ?????????!'),
(20020, 'The Horde won the second round, the Relic of Titan was captured!', NULL, NULL, 'Die Horde hat die zweite Runde gewonnen, das Titanenportal erobert!', NULL, NULL, '!La Alianza gana la segunda ronda! !La reliquia de Titán ha sido capturada!', '!La Alianza gana la segunda ronda! !La reliquia de Titán ha sido capturada!', '?????? ????? ?? ?????! ???????? ?????? ?????????!'),
...
(20028, 'The Gate of the Green Emerald was destroyed!', NULL, NULL, 'Das Tor des Smaragdhorizonts ist zerstort!', NULL, NULL, '!La puerta de la Esmeralda Verde ha sido destruida!', '!La puerta de la Esmeralda Verde ha sido destruida!', '????? ???????? ???????? ?????????!'),
(20029, 'The Gate of the Blue Sapphire was destroyed!', NULL, NULL, 'Das Tor des Saphirhimmels ist zerstort!', NULL, NULL, '!La puerta del Zafiro Azul ha sido destruida!', '!La puerta del Zafiro Azul ha sido destruida!', '????? ?????? ??????? ?????????!'),
(20030, 'The Gate of the Purple Amethyst was destroyed!', NULL, NULL, 'Das Tor des Amethyststerns ist zerstort worden', NULL, NULL, '!La puerta de la Amatista Púrpura ha sido destruida!', '!La puerta de la Amatista Púrpura ha sido destruida!', '????? ???????? ???????? ?????????!'),
(20031, 'The Gate of the Red Sun was destroyed!', NULL, NULL, 'Das Tor der Rubinsonne ist zerstort worden!', NULL, NULL, '!La puerta del Sol Rojo ha sido destruida!', '!La puerta del Sol Rojo ha sido destruida!', '????? ???????? ?????? ?????????!'),
(20032, 'The Gate of the Yellow Moon was destroyed!', NULL, NULL, 'Das Tor des Goldmondes ist zerstort worden!', NULL, NULL, '!La puerta de la Luna Amarilla ha sido destruida!', '!La puerta de la Luna Amarilla ha sido destruida!', '????? ?????? ???? ?????????!'),
...
(20034, 'The Gate of the Green Emerald is damaged!', NULL, NULL, 'Das Tor des Smaragdhorizonts ist beschadigt worden', NULL, NULL, '!La puerta de la Esmeralda Verde ha sido danada!', '!La puerta de la Esmeralda Verde ha sido danada!', '????? ???????? ???????? ??????????!'),
(20035, 'The Gate of the Blue Sapphire is damaged!', NULL, NULL, 'Das Tor des Saphirhimmels ist beschadigt worden!', NULL, NULL, '!La puerta del Zafiro Azul ha sido danada!', '!La puerta del Zafiro Azul ha sido danada!', '????? ?????? ??????? ??????????!'),
(20036, 'The Gate of the Purple Amethyst is damaged!', NULL, NULL, 'Das Tor des Amethyststerns ist beschadigt worden!', NULL, NULL, '!La puerta de la Amatista Púrpura ha sido danada!', '!La puerta de la Amatista Púrpura ha sido danada!', '????? ???????? ???????? ??????????!'),
(20037, 'The Gate of the Red Sun is damaged!', NULL, NULL, 'Das Tor der Rubinsonne ist beschadigt worden!', NULL, NULL, '!La puerta del Sol Rojo ha sido danada!', '!La puerta del Sol Rojo ha sido danada!', '????? ???????? ?????? ??????????!'),
(20038, 'The Gate of the Yellow Moon is damaged!', NULL, NULL, 'Das Tor des Goldmondes ist beschadigt worden!', NULL, NULL, '!La puerta de la Luna Amarilla ha sido danada!', '!La puerta de la Luna Amarilla ha sido danada!', '????? ?????? ???? ??????????!'),
(20039, 'The Horde won the first round, the Relic of Titan was no captured!', NULL, NULL, 'Runde 1 - Beendet!', NULL, NULL, '!Ronda 1 acabada!', '!Ronda 1 acabada!', '?????? ????? ?? ?????! ???????? ?????? ?? ???? ?????????!'),
(20040, 'The Alliance won the first round, the Relic of Titan was no captured!', NULL, NULL, 'Runde 1 - Beendet!', NULL, NULL, '!Ronda 1 acabada!', '!Ronda 1 acabada!', '?????? ????? ?? ????????! ???????? ?????? ?? ???? ?????????!'),
(20041, 'The Horde won the second round, the Relic of Titan was no captured!', NULL, NULL, 'Runde 2 - Beendet!', NULL, NULL, '!Ronda 2 acabada!', '!Ronda 2 acabada!', '?????? ????? ?? ?????! ???????? ?????? ?? ???? ?????????!'),
(20042, 'The Alliance won the second round, the Relic of Titan was no captured!', NULL, NULL, 'Runde 2 - Beendet!', NULL, NULL, '!Ronda 2 acabada!', '!Ronda 2 acabada!', '?????? ????? ?? ????????! ???????? ?????? ?? ???? ?????????!'),
(20043, 'Round 1 - Finished!',  NULL,  NULL,  'Runde 1 - Beendet!',  NULL,  NULL,  '!Ronda 1 acabada!', '!Ronda 1 acabada!', NULL),
(20044, 'The game has ended in a draw!', NULL, NULL, 'Das Spiel ist unentschieden!!!', NULL, NULL, '!El campo de batalla ha acabado en empate!', '!El campo de batalla ha acabado en empate!', '?????!!!');
