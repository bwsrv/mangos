...
(607, 0, 1, 'East - A ocup'),
(607, 0, 2, 'East - H ocup'),
(607, 0, 3, 'East - A seizes'),
(607, 0, 4, 'East - H seizes'),
(607, 1, 1, 'West - A ocup'),
(607, 1, 2, 'West - H ocup'),
(607, 1, 3, 'West - A seizes'),
(607, 1, 4, 'West - H seizes'),
(607, 2, 1, 'Middle - A ocup'),
(607, 2, 2, 'Middle - H ocup'),
(607, 2, 3, 'Middle - A seizes'),
(607, 2, 4, 'Middle - H seizes');
...
(20036, 'The Chamber of Ancient Relics was destroyed!', NULL, NULL, 'In die Kammer wird eingebrochen! Der Titan ist in Gefahr!', NULL, NULL, '¡La puerta de la Cámara de Reliquias antiguas ha sido destruida!', '¡La puerta de la Cámara de Reliquias antiguas ha sido destruida!', 'Комната древних святынь разрушена!'),
...
(20039, 'The Gate of the Purple Amethyst was destroyed!', NULL, NULL, 'Das Tor des Amethyststerns ist zerstort worden', NULL, NULL, '¡La puerta de la Amatista Púrpura ha sido destruida!', '¡La puerta de la Amatista Púrpura ha sido destruida!', 'Врата Лилового Аметиста разрушены!'),
...
(20042, 'The Chamber of Ancient Relics is damaged!', NULL, NULL, 'Die Kammer der Uralten ist beschadigt worden!', NULL, NULL, '¡La puerta de la Cámara de Reliquias antiguas ha sido dañada!', '¡La puerta de la Cámara de Reliquias antiguas ha sido dañada!', 'Комната древних святынь повреждена!'),
(20043, 'The Gate of the Green Emerald is damaged!', NULL, NULL, 'Das Tor des Smaragdhorizonts ist beschadigt worden', NULL, NULL, '¡La puerta de la Esmeralda Verde ha sido dañada!', '¡La puerta de la Esmeralda Verde ha sido dañada!', 'Врата Зеленого Изумруда повреждены!'),
(20044, 'The Gate of the Blue Sapphire is damaged!', NULL, NULL, 'Das Tor des Saphirhimmels ist beschadigt worden!', NULL, NULL, '¡La puerta del Zafiro Azul ha sido dañada!', '¡La puerta del Zafiro Azul ha sido dañada!', 'Врата Синего Сапфира повреждены!'),
(20045, 'The Gate of the Purple Amethyst is damaged!', NULL, NULL, 'Das Tor des Amethyststerns ist beschadigt worden!', NULL, NULL, '¡La puerta de la Amatista Púrpura ha sido dañada!', '¡La puerta de la Amatista Púrpura ha sido dañada!', 'Врата Лилового Аметиста повреждены!'),
(20046, 'The Gate of the Red Sun is damaged!', NULL, NULL, 'Das Tor der Rubinsonne ist beschadigt worden!', NULL, NULL, '¡La puerta del Sol Rojo ha sido dañada!', '¡La puerta del Sol Rojo ha sido dañada!', 'Врата Красного Солнца повреждены!'),
(20047, 'The Gate of the Yellow Moon is damaged!', NULL, NULL, 'Das Tor des Goldmondes ist beschadigt worden!', NULL, NULL, '¡La puerta de la Luna Amarilla ha sido dañada!', '¡La puerta de la Luna Amarilla ha sido dañada!', 'Врата Желтой Луны повреждены!'),
...
DELETE FROM gameobject_battleground WHERE guid BETWEEN 200008 AND 200174;
INSERT INTO gameobject_battleground VALUES
(200008, 0, 3),
(200009, 0, 1),
(200010, 0, 4),
